...
class SVDDecompositionUtil(object):
    ...
    def plotImage(self):
        ...
        plt.title("%s Keeping 5 Percent of Singular Values" % (self.displayName))        
        plt.subplot(233)
        plt.imshow(self.reconstructTargetImage(int(0.10*len(self.singularValues))), cmap='gray')
        plt.title("%s Keeping 10 Percent of Singular Values" % (self.displayName))
        plt.subplot(234)
        plt.imshow(self.reconstructTargetImage(int(0.25*len(self.singularValues))), cmap='gray')
        plt.title("%s Keeping 25 Percent of Singular Values" % (self.displayName))
        plt.subplot(235)
        plt.imshow(self.reconstructTargetImage(int(0.50*len(self.singularValues))), cmap='gray')
        plt.title("%s Keeping 50 Percent of Singular Values" % (self.displayName))        
        plt.subplot(236)
